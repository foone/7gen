...
name='Skyline Test'
author='Travis Wells'
shortname='trav_skylinetest' # out file will be shortname with a 'vxp' extension

#These both need to be 544x306:
background='skyline.bmp'
depth='depth.bmp' # Set to None if you want a blank ZBMP.

preview='-preview.bmp' #this should be 128x72
dither=True
